...
@Controller
public class AutoCompleteKeyController {

	@Autowired
	private AutoCompleteService autoCompleteService;

	@RequestMapping(value = "/ac/key", method = RequestMethod.GET)
	public ModelAndView get(@RequestParam String input) {
		List<NodeValueResult> result = autoCompleteService.searchByKey(input);
		return new ModelAndView("acKeyResult", "result", result);
	}
}
