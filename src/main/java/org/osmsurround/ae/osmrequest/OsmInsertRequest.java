...
@Service
public class OsmInsertRequest extends OsmSignedRequestTemplate {

	protected OsmInsertRequest() {
		super("Amenity Editor Insert");
	}
	...
	protected HttpRequestBase createRequest(OsmNode amenity, int changesetId) throws Exception {
		...
		HttpEntityEnclosingRequestBase request = new HttpPut(osmApiBaseUrl + "/api/0.6/node/create");
