...
@Service
public class OsmUpdateRequest extends OsmSignedRequestTemplate {

	protected OsmUpdateRequest() {
		super("Amenity Editor Update");
	}
	...
	protected HttpRequestBase createRequest(OsmNode amenity, int changesetId) throws Exception {
		...
		HttpEntityEnclosingRequestBase request = new HttpPut(osmApiBaseUrl + "/api/0.6/node/" + amenity.getId());
